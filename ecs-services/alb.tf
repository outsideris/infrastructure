...
module "pinkfong8_alb_http" {
  source           = "./modules/alb-listener"
  alb_arn          = "${module.pinkfong8_alb.arn}"
  port             = "80"
  protocol         = "HTTP"
  target_group_arn = "${module.ecs_service_pinkfong8.target_group_arn}"
}

module "pinkfong8_alb_http_rule" {
  source           = "./modules/alb-listener-rule"
  listener_arn     = "${module.pinkfong8_alb_http.arn}"
  priority         = 100
  target_group_arn = "${module.ecs_service_pinkfong8.target_group_arn}"
  condition_field  = "path-pattern"
  condition_values = ["/*"]
